 ...
 * Family controller.
 *
 * @Route("/consumableFamily")
 * @Security("user.isSuperAdmin() or has_role('ROLE_GESTION_FAMILY')")
 */
class FamilyConsumableController extends Controller
{
     ...
     *
     * @Route("/index", name="familyconsumable_index")
     * @Method({"GET", "POST"})
    ...
    public function indexAction(Request $request)
    {
        ...
        $query = $entityManager->getEntityBy($this->getDoctrine()->getRepository(FamilyConsumable::class), $this->getUser() ,self::ROLE, $form);
        ...
        return $this->render('ISETSOMagazineBundle:familyconsumable:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('familyconsumable_index');
        }

        return $this->render('ISETSOMagazineBundle:familyconsumable:new.html.twig', array(
            'family' => $family,
            'form' => $form->createView(),
        ));
    }
     ...
     *
     * @Route("/{id}", name="familyconsumable_show")
     * @Method("GET")
     * @Security("is_granted('View', 'ROLE_GESTION_FAMILY') or is_granted('Manager', 'ROLE_GESTION_FAMILY')")
     */
    public function showAction(Request $request,FamilyConsumable $family)
    {
        $entityManager = $this->getEntityManager();
        $form = $this->createForm(SearchType::class)->handleRequest($request);
        ...
        return $this->render('ISETSOMagazineBundle:familyconsumable:show.html.twig', array(
            'family' => $family,
            'families' => $entityManager->createPaginator($query ,$request),
            'form'=> $form->createView(),
            'deleteForms' => $deleteForms
    ...
    public function editAction(Request $request, FamilyConsumable $family)
    {
        ...
        return $this->render('ISETSOMagazineBundle:familyconsumable:edit.html.twig', array(
            'family' => $family,
     ...
     */
    private function createDeleteForm(FamilyConsumable $family)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('familyconsumable_delete', array('id' => $family->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
