...
/**
 * DetailDischargeArticle
 *
 * @ORM\Table(name="detail_discharge_article")
 * @ORM\Entity(repositoryClass="ISETSO\MagazineBundle\Repository\DetailArticleManagement\DetailDischargeArticleRepository")
 */
class DetailDischargeArticle extends Detail
{
    /**
     * @var int
     *
