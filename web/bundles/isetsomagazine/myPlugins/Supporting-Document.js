...
(function ($) {
					...
					$(".edit").click(function() {
                		...
                		$.ajax({
				            ...
				            success: function(json){
				                ...
				                $('#supporting_document_'+opts.articleType+'_article').select2().select2("val",supportingDocument.id,false);
				            }
				        });
	...
	$.fn.supportingDocument.defaults = {
		...
		addEditUrl: 'supportingdocumentconsumable_new',
		indexUrl: 'supportingdocumentconsumable_session_index',
